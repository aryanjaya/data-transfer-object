...
class CustomCasterArgumentsTest extends TestCase
{
    ...
    public function test_it_throws_exception_when_casting_non_array()
    {
        ...
        $this->expectExceptionMessage(
            "Caster [ArrayCaster] each item must be an array or an instance of the specified item type [Aryanjaya\DataTransferObject\Tests\Foo]."
        );
...
class Bar extends DataTransferObject
{
    ...
    /** @var \Aryanjaya\DataTransferObject\Tests\Baz[] */
